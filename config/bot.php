...
return [
    ...
    'bot_node_exp' => 'http://pay.joyvpn.fun/api/send-notif-exp',
    'bot_node_vol' => 'http://pay.joyvpn.fun/api/send-notif-vol',
    ...
    'introduce_url' => 'http://pay.joyvpn.fun/api/send-server-introduce',
];